...
import (
	...
	cosmosevmcmd "github.com/xitcoin-org/pos-chain/client"
	evmdebug "github.com/xitcoin-org/pos-chain/client/debug"
...
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:   config.AppName,
		Short: "Xitcoin EVM blockchain daemon",
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customAppTemplate, customAppConfig := config.InitAppConfig(config.NativeDenom, config.TestnetEVMChainID) // TODO:VLAD - Remove this
...
func initCometConfig() *cmtcfg.Config {
	...
	// Cosmos EVM uses the application-side mempool.
