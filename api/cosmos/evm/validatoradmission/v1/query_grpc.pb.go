...
const (
	Query_Params_FullMethodName    = "/cosmos.evm.validatoradmission.v1.Query/Params"
	Query_Validator_FullMethodName = "/cosmos.evm.validatoradmission.v1.Query/Validator"
)
