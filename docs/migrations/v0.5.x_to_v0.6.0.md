...
- Bump `github.com/xitcoin-org/pos-chain` to v0.6.0 and run:
...
```diff
- import (
-     "github.com/xitcoin-org/pos-chain/x/ibc/transfer"
-     transferkeeper "github.com/xitcoin-org/pos-chain/x/ibc/transfer/keeper"
-     transferv2 "github.com/xitcoin-org/pos-chain/x/ibc/transfer/v2"
