...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"cosmos", "evm", "validatoradmission", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Validator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"cosmos", "evm", "validatoradmission", "v1", "validators", "validator_address"}, "", runtime.AssumeColonVerbOpt(false)))
)
