/**
 * This flattened contract is almost identical to the Ethereum mainnet Maker (MKR) token contract:
 * https://etherscan.io/address/0x9f8F72aA9304c8B593d555F12eF6589cC3A579A2#code
 *
 * It is used in integration tests to ensure compatibility with bytes32-based name and symbol fields.
 */
...
contract Bytes32MetadataToken is DSTokenBase(0), DSStop {
