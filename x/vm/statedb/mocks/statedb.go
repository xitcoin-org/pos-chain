...
// EmitLogsForBurnAccounts provides a mock function with no fields
func (_m *StateDB) EmitLogsForBurnAccounts() {
	_m.Called()
}
...
// IsNewContract provides a mock function with given fields: addr
func (_m *StateDB) IsNewContract(addr common.Address) bool {
	ret := _m.Called(addr)

	if len(ret) == 0 {
		panic("no return value specified for IsNewContract")
	}
...
// SetCode provides a mock function with given fields: _a0, _a1, _a2
func (_m *StateDB) SetCode(_a0 common.Address, _a1 []byte, _a2 tracing.CodeChangeReason) []byte {
	ret := _m.Called(_a0, _a1, _a2)
	...
	var r0 []byte
	if rf, ok := ret.Get(0).(func(common.Address, []byte, tracing.CodeChangeReason) []byte); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
